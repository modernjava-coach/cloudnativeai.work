export default function LandingPage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-b from-slate-900 to-slate-800 text-white px-6 py-12 text-center">
      ...
      <section className="space-y-6">
        <h2 className="text-2xl font-semibold text-cyan-300">Coming Soon</h2>
